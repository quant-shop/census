...
header-includes: |
  \setbeamertemplate{title page}{
    \begin{centering}
      ...
      Program in Applied Data Science and Analytics, CADSA \\
      Director, Quantitative Histories Workshop
      \end{tabular}
    \end{centering}
  }
  \usepackage{graphicx}
...
\begin{center}
\includegraphics[width=1\textwidth]{img/lab-people.png}
\end{center}
...
There are dynamic and complex historical structures that have isolated and segregated communities based on a host of factors.

- Legacies of Jim Crow
...
Multiple year study on how modeling historical injustices better frames educational, economic, and political outcomes.
...
\begin{center}
\includegraphics[width=0.25\textwidth]{img/Picture2.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.25\textwidth]{img/figurec.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.25\textwidth]{img/Picture1.png}
\end{center}
...
$$
D = \dfrac{1}{2} \sum_{i=1}^{n} \Big| \dfrac{b_i}{B} - \dfrac{w_i}{W} \Big|
$$
Where:
...
# Modeling Antiblackness

\begin{center}
\includegraphics[width=0.90\textwidth]{img/model1.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.90\textwidth]{img/model2.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.90\textwidth]{img/model3.png}
\end{center}
...
## Findings: Information and spatial segregation

There are multiple models to be considered:
...
**Research assistants**: Bayowa Onabajo (Howard University), Jibek Gupta (Howard University), Myles Ndiritu (Morehouse College), Zoe Williams (Howard University)
