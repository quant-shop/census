...
Files on the Census tracts from various historical periods are uploaded from DC Open Data. Additional data files can be accessed from the DC Open Data website [here](https://opendata.dc.gov/) and include KML, GeoJSON, and shapefies.
